...
Path('README.md').write_text('''# iTransformer: hourly Bitcoin walk-forward research
...
Path('USAGE.md').write_text(r'''# Running the iTransformer notebook
...
''', encoding='utf-8')
print('Updated notebook-first README and Kaggle runbook')
